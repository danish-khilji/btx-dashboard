...
function Card() {
    const [bridgdata, setBridgedata] = useState([]);
    ...
    const url1 = `${baseurl}:${port}/swap-fee`;
    ...
    return (
        <div className="items-center px-4">
            <div className="flex flex-wrap pb-3 mx-4 md:mx-24 lg:mx-0">
                <div className="w-full p-2 lg:w-1/3 md:w-1/3 flex flex-col">
                    <div className="flex flex-col px-6 py-10 overflow-hidden bg-white hover:bg-gradient-to-br from-purple-400 via-blue-400 to-blue-500 rounded-xl shadow-lg duration-300 hover:shadow-2xl group flex-grow">
                        <div className="flex flex-row justify-between items-center">
                            ...
                            <div className="inline-flex text-sm text-gray-600 group-hover:text-gray-200 sm:text-base">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2 text-green-500 group-hover:text-gray-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 12H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                            </div>
                        </div>
                        <h1 className="text-3xl sm:text-4xl xl:text-5xl font-bold text-gray-700 mt-12 group-hover:text-gray-50">
                            {bridgdata.length > 0 ? bridgdata[0].value : "No data"}
                        </h1>
                ...
                <div className="w-full p-2 lg:w-1/3 md:w-1/3 flex flex-col">
                    <div className="flex flex-col px-6 py-10 overflow-hidden bg-white hover:bg-gradient-to-br from-purple-400 via-blue-400 to-blue-500 rounded-xl shadow-lg duration-300 hover:shadow-2xl group flex-grow">
                        ...
                        <h1 className="text-3xl sm:text-4xl xl:text-5xl font-bold text-gray-700 mt-12 group-hover:text-gray-50">
                            {swapdata.length > 0 ? swapdata[0].value : "No data"}
                        </h1>
                        <div className="flex flex-row justify-between group-hover:text-gray-200">
                            <p>Swap Fee</p>
                            <span>
                ...
                <div className="w-full p-2 lg:w-1/3 md:w-1/3 flex flex-col">
                    <div className="flex flex-col px-6 py-10 overflow-hidden bg-white hover:bg-gradient-to-br from-purple-400 via-blue-400 to-blue-500 rounded-xl shadow-lg duration-300 hover:shadow-2xl group flex-grow">
                        ...
                        <h1 className="text-3xl sm:text-4xl xl:text-5xl font-bold text-gray-700 mt-12 group-hover:text-gray-50">0
                        </h1>
                        <div className="flex flex-row justify-between group-hover:text-gray-200">
                            <p>user</p>
                        </div>
